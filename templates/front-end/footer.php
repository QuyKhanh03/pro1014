<footer class="footer-wrapper footer-layout1" data-bg-src="public/layout/assets/img/bg/footer_bg_1.jpg">
        <div class="container">
            <div class="footer-top">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <div class="footer-logo"><img src="public/layout/assets/img/logo-white.svg" alt="Pizzer"></div>
                    </div>
                    <div class="col-xl-9">
                        <div class="subscribe-box">
                            ...
                            <form class="newsletter-form"><input class="form-control" type="email"
                                    ...
                                    class="as-btn style3">SUBCRIBE<i class="fas fa-arrow-right ms-2"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget footer-widget">
                            ...
                            <div class="as-widget-contact">
                                <div class="info-box">
                                    ...
                                    <p class="info-box_text">1403 Washington Ave, New Orlea ns, LA 70130, United States
                                    </p>
                                </div>
                                <div class="info-box">
                                ...
                                <div class="info-box">
                                    ...
                                    <p class="info-box_text"><a href="mailto:info@pizzer.com"
                                            class="info-box_link">info@pizzer.com</a> <a
                                            href="mailto:info.example@pizzer.com"
                                            class="info-box_link">info.example@pizzer.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="public/layout/assets/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="public/layout/assets/js/app.min.js"></script>
    <script src="public/layout/assets/js/main.js"></script>
</body>
<!-- Mirrored from angfuzsoft.com/html/pizzer/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 08:42:27 GMT -->
